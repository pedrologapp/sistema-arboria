-- =============================================
-- VIEWS DE RANKING - PROJETO ARBORIA
-- =============================================

-- VIEW 1: ranking_casas
-- Ranking das 8 casas por pontos totais
CREATE OR REPLACE VIEW ranking_casas AS
SELECT
  i.id as casa_id,
  i.nome as casa_nome,
...
-- VIEW 2: ranking_alunos_por_casa
-- Ranking de alunos dentro de cada casa
CREATE OR REPLACE VIEW ranking_alunos_por_casa AS
SELECT
  p.id as aluno_id,
...
-- VIEW 3: perfil_inteligencias_aluno
-- As 8 barras de inteligência de um aluno
CREATE OR REPLACE VIEW perfil_inteligencias_aluno AS
SELECT
  s.aluno_id,
  s.ano_letivo,
