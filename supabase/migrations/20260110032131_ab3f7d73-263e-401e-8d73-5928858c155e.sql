-- Dropar função existente para recriar com tipos corretos
DROP FUNCTION IF EXISTS public.get_missoes_do_aluno(uuid);

-- Recriar com CAST explícito para resolver incompatibilidade de tipos
...
BEGIN
  ...
  SELECT 
    ...
    m.descricao,
    m.tipo,
    m.pontos_base::integer,  -- CAST explícito de smallint para integer
    m.data_liberacao,
    m.data_prazo,
    ...
    i.id::integer as casa_id,  -- CAST explícito de smallint para integer
    i.nome as casa_nome,
