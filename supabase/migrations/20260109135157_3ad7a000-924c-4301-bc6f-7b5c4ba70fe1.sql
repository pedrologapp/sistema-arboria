-- Corrigir ambiguidade de fase_numero na função fechar_fase
...
BEGIN
  ...
  LOOP
    ...
    FOR v_im IN SELECT id FROM inteligencias ORDER BY id LOOP
      ...
      -- Salvar histórico (snapshot) - usando alias para evitar ambiguidade
      INSERT INTO inteligencia_historico AS ih (
