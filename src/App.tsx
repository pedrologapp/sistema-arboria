...
const ArboriaRepositorioPage = lazy(() => import("./pages/arboria/ArboriaRepositorioPage"));
      ...
      <BrowserRouter>
        <AuthProvider>
          ...
          <Routes>
            ...
            <Route path="/familia" element={<QuestionarioPaisPreview />} />
            ...
            <Route path="/arboria/coleta" element={
              <ProtectedRoute requireSuperAdmin>
                <ArboriaAdminLayout>
                  <ArboriaColetaPage />
                </ArboriaAdminLayout>
