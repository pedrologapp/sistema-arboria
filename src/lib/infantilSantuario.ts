...
export const SANTUARIO_INFANTIL: Record<number, SantuarioMecanismo> = {
  1: {
    ...
    revela: [
      ...
      'Pode enganar: pode ser a criança quieta, que quase não fala na roda, e em casa reconta sua aula inteira. A inteligência opera por dentro, sem plateia',
      'Pode enganar: pode trocar sons, pronunciar "errado", e construir histórias com estrutura. A pronúncia é habilidade; a narrativa é a inteligência',
    ],
  ...
  2: {
    ...
    lente: 'Quando você repara na criança que entra pelo padrão, a repetição dela deixa de ser capricho e vira método, e você pode alimentar o método em vez de interrompê-lo. A pergunta encadeada deixa de ser desafio à sua paciência e vira a inteligência pedindo mais um elo. E a criança que "demora" ganha o tempo que o raciocínio dela precisa. Você só passa a oferecer mundos com regras para descobrir.',
    observar: [
  ...
  5: {
    ...
    revela: [
      ...
      'Pode enganar: pode ser quieta, nada esportiva, e só compreender quando toca e manipula. E pode se atrapalhar com tesoura: motricidade fina é habilidade treinável; a inteligência é outra coisa',
    ],
    veMundo: 'O mundo chega pelo corpo antes de chegar pelo pensamento. Quando aprende algo novo, a compreensão acontece no momento em que as mãos fazem. Quando processa algo difícil, o corpo se move: levanta, gesticula, pega. Não é inquietação: é a inteligência pensando. O filtro é o fazer: a experiência só vira real quando passa pelo movimento.',
    ...
    cuidado: 'Agitação não é esta inteligência. E a criança quieta, concentrada nas próprias mãos, pode estar com ele em plena atividade. Descreva o movimento, não o comportamento.',
  },
  6: {
    nome: 'Naturalista',
    cor: '#78350F',
    ...
    revela: [
      ...
      'Pode enganar: pode ser criança de apartamento, sem interesse por natureza, e a inteligência aparecer inteira na fileira de carrinhos',
      'Pode enganar: pode parecer desligada em atividades muito abertas, sem nada pra comparar. Não é desinteresse: é a inteligência sem material para operar',
    ],
    veMundo: 'O mundo chega em categorias. Diante de qualquer conjunto: objetos, figuras, pessoas; a inteligência começa a trabalhar: o que é igual? o que é diferente? onde termina um grupo e começa o outro? Ela não decide perceber a distinção. A distinção já chegou antes da decisão de percebê-la.',
  ...
  7: {
    ...
    revela: [
      ...
      'Pode enganar: pode usar a leitura a favor de si; conseguir o que quer porque percebeu como cada adulto reage. É a inteligência sem a parte ética, que ainda está em construção. Inteligência não é virtude',
    ],
  ...
  8: {
    ...
    veMundo: 'O mundo chega filtrado pelo estado interno. Antes de reagir, há um instante, quase imperceptível: em que a inteligência registra como ela está e por quê. O que para outras crianças é um sentimento embolado, para ela chega com etiqueta: não era bem raiva, era frustração. A experiência interna vira informação antes de virar comportamento.',
    lente: 'Quando você repara na criança que processa por dentro, o "tempo dela" deixa de ser lentidão e vira etapa: ela precisa acessar o próprio estado antes de agir, e cobrar resposta imediata é fechar a porta. O canto onde ela se recompõe deixa de ser fuga e vira ferramenta, que você pode proteger em vez de interromper. E como essa inteligência quase não se mostra sozinha, o seu olhar é o que impede que ele passe despercebido. Reparar já é a metade do trabalho.',
    observar: [
