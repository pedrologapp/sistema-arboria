...
/** O galho do Cross-IM. Sem destaque visual (decisão do Fundador). */
...
export const LEQUE_CAMINHOS: LequeOpcao[] = [
  { l: 'em voz alta', t: 'contou tudo em voz alta, como uma história.' },
  { l: 'por uma regra', t: 'montou uma regra: se um é assim, o outro tem que ser.' },
  { l: 'pela imagem', t: 'foi pela imagem, desenhou pra enxergar.' },
  { l: 'no ritmo', t: 'no ritmo, marcando uma batida enquanto fazia.' },
  { l: 'com as mãos', t: 'com as mãos, só entendeu depois de pegar.' },
  { l: 'nas diferenças', t: 'reparou nas diferenças finas que ninguém viu.' },
  { l: 'com o grupo', t: 'puxando os colegas, lendo o grupo.' },
  { l: 'no seu tempo', t: 'no seu tempo, sabendo a hora de parar.' },
];
