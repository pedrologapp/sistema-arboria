...
export const GLOSSARIO: Record<string, string> = {
  ...
  'corporal_cinestesica': 'Quem aprende fazendo e se movendo. O corpo pensa junto com a mente.',
  'naturalista': 'Quem classifica, organiza e percebe padrões na natureza e no mundo.',
  'interpessoal': 'Quem entende as pessoas naturalmente. Percebe emoções, intenções e o clima de um grupo.',
  'intrapessoal': 'Quem se conhece profundamente. Sabe o que sente e usa isso para decidir melhor.',
...
// Nomes amigáveis para cada inteligência
export const NOMES_INTELIGENCIA: Record<string, string> = {
