...
const FechoPrompt = ({
  ...
  >
    <p className="text-[10.5px] uppercase tracking-wide font-bold" style={{ color: fio?.corDia ?? t.accentText }}>
      Fim de aula{moduloNome ? ` · ${moduloNome}` : ''}
    </p>
    ...
    <p className="text-sm mt-2 leading-relaxed" style={{ color: t.textMuted }}>
      Toque só nos alunos que se destacaram. Conte a cena em uma linha e, se der, guarde a foto do
    ...
    <div>
      ...
      <div className="pt-16 space-y-4">
        ...
        {faseLoading ? (
          ...
          <>
            {modoFecho ? (
              <FechoPrompt moduloNome={moduloNome} fio={fio} />
            ) : (
              <>
