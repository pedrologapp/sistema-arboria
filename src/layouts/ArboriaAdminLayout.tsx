...
import { LayoutDashboard, Library, KeyRound, Route, BookOpen, Users, LogOut, RotateCcw, KanbanSquare, FolderOpen, ClipboardList, Beaker } from 'lucide-react';
...
const ArboriaAdminLayout = ({ children }: { children: ReactNode }) => {
  ...
  const abas = [
    ...
    { label: 'Casos', path: '/arboria/casos', icon: <Beaker size={17} strokeWidth={1.75} /> },
