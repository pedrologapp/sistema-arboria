...
import { Activity, Users, Shield, Calendar, MessageCircle, Settings, FileText } from 'lucide-react';
...
const AdminBottomNav = () => {
  ...
  const navItems: NavItemConfig[] = [
    ...
    { id: 'atividades', icon: <FileText size={18} />, label: 'Logs', path: '/admin/atividades' },
