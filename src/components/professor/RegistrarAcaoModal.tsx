        ...
        <div className="p-4 space-y-5">
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full h-28 px-3 py-2 rounded-xl bg-white/5 border border-white/10 text-white placeholder-white/30 text-sm resize-none focus:outline-none focus:border-blue-500/50"
            />
          </div>
